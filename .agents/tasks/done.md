...
- [x] 2026-09-07: Implemented single-user Argon2id login, bounded server-side sessions, team-CIDR nginx ingress and loopback backend authorization. Added `test/auth/` suites and updated runbooks. Actual target-host ingress validation remains in `active.md`.
...
- [x] 2026-09-06: Made root `logo.png` the canonical runtime asset and disabled caching for it.
